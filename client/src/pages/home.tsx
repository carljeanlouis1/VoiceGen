    ...
    <AppLayout>
      <div className="container max-w-4xl py-8 space-y-8">
        <div className="text-center mb-6">
          <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-[#0A84FF] to-[#5E5CE6] bg-clip-text text-transparent">VoiceGen</h1>
          <p className="text-lg text-zinc-400">Advanced AI-powered multimedia tools</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Card className="bg-zinc-800/50 border border-zinc-700 hover:border-zinc-600 transition-colors">
            <CardHeader>
              <div className="flex items-center">
                <Headphones className="h-5 w-5 mr-2 text-[#0A84FF]" />
            ...
            <CardContent className="pt-2">
              ...
              <Link href="/convert">
                <Button className="w-full bg-[#0A84FF] hover:bg-[#0074E0]">Convert Text to Speech</Button>
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="bg-zinc-800/50 border border-zinc-700 hover:border-zinc-600 transition-colors">
            <CardHeader>
              <div className="flex items-center">
                <Sparkles className="h-5 w-5 mr-2 text-[#5E5CE6]" />
            ...
            <CardContent className="pt-2">
              ...
              <Link href="/create">
                <Button className="w-full bg-[#5E5CE6] hover:bg-[#4E4CD6]">Create Content</Button>
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="bg-zinc-800/50 border border-zinc-700 hover:border-zinc-600 transition-colors">
            <CardHeader>
              <div className="flex items-center">
                <MessageSquare className="h-5 w-5 mr-2 text-[#30D158]" />
            ...
            <CardContent className="pt-2">
              ...
              <Link href="/chat">
                <Button className="w-full bg-[#30D158] hover:bg-[#28B14C]">Start Chatting</Button>
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="bg-zinc-800/50 border border-zinc-700 hover:border-zinc-600 transition-colors">
            <CardHeader>
              <div className="flex items-center">
                <Search className="h-5 w-5 mr-2 text-[#FF9F0A]" />
            ...
            <CardContent className="pt-2">
              ...
              <Link href="/search">
                <Button className="w-full bg-[#FF9F0A] hover:bg-[#E08900]">Search the Web</Button>
              </Link>
            </CardContent>
          </Card>
        </div>
